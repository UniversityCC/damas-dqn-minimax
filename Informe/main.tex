...
\begin{table}[H]
\centering
\caption{Progresión de las mejoras: tasa de victoria del DQN (evaluación estocástica, 30 partidas) contra Minimax. La columna d=4 es \emph{de reserva} (no usada en el currículum) y, por tanto, la comparación más limpia.}
\begin{tabular}{lcc}
\toprule
...
\noindent{\footnotesize $^{*}$ En la Fase 2, Minimax(d=3) es el oponente de \emph{entrenamiento} (currículum); por eso la métrica fiel de generalización es la columna d=4 (no vista en el currículum).}
...
\begin{table}[H]
\centering
\caption{Clasificación ELO tras el torneo final. La etiqueta \texttt{ep} del DQN indica pasos de aprendizaje ($\approx 4000$ episodios), no episodios.}
\begin{tabular}{clc}
\toprule
Posición & Agente & ELO \\
\midrule
