...
Los experimentos confirman cuatro resultados principales. Primero, la infraestructura de evaluación es correcta y la clasificación ELO refleja fielmente el rendimiento de los agentes. Segundo, el DQN puro entrenado con las mejoras de la Fase 2 alcanza el tercer lugar general, evidenciando que las mejoras algorítmicas superan al simple aumento de episodios. Tercero, el DQN reactivo sufre de un límite estructural (ejemplificado en sus derrotas ante Minimax d=5) que le impide equiparar cálculos profundos en una sola pasada. Cuarto, la introducción del agente híbrido resuelve dicho límite: empleando la red (fortalecida por el ``Maestro A'') como evaluador de una búsqueda negamax ($k=5$), el agente resultante supera consistentemente a Minimax en todas sus variantes (alcanzando hasta 97.5\,\% de victorias).
